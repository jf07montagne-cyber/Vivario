/* trailer_34.js — Vivario trailer v3.4 (ciné)
   - autoplay VISUEL (mobile-safe)
   - audio/voix se débloquent au 1er tap (restriction navigateur)
   - whoosh soft transitions + impact reveal final
*/
(() => {
