/* ui.js — micro animations premium (safe) v18
   PATCH: suppression injection "Vivario PRO entry" sur accueil.html
   -> Ne change rien aux pages validées, sauf retirer le bloc PRO injecté.
*/
(() => {
  ...
  // ✅ IMPORTANT : on n'injecte PLUS rien dans accueil.html
  // (le PRO a désormais son accueil_pro.html dédié)
})();