/* Vivario v1.1 — engine.js (FINAL + scénarios uniques par personne)
   ✅ Ajoute vivario_user_id persistant (unique device)
   ✅ Seed inclut user_id => même réponses ≠ même scénario sur 2 appareils
   ✅ Le reste = ta base stable
*/
...
(() => {
  ...
  const KEY_USER  = "vivario_user_id"; // ✅ NEW
  const MEM_MAX   = 350;
  ...
  // Final message (inchangé chez toi)
  ...
  function buildScenarioForVariant(profile, variantKey, usedStrictGlobal){
    ...
    // ✅ SEED inclut userId => unique par personne
